...
import com.unfpa.appsistenciamaternaunfpa.adapters.nurse.chat.ChatRoomAdapterPatientDoctor
...
import kotlinx.android.synthetic.main.activity_chatroom_patient.*
import org.json.JSONObject


class ChatRoomActivityPatient : AppCompatActivity(), View.OnClickListener {

    private var toolbar: Toolbar? = null
    val TAG = ChatRoomActivityPatient::class.java.simpleName
    ...
    lateinit var chatRoomAdapterPatient: ChatRoomAdapterPatientDoctor

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chatroom_patient)
...
//            Toast.makeText(this, userName.toString() + roomName.toString(), Toast.LENGTH_LONG).show()
        ...
        chatRoomAdapterPatient = ChatRoomAdapterPatientDoctor(this, chatList);
        recyclerViewP.adapter = chatRoomAdapterPatient;
...
//    }
    ...
    private fun sendMessage() {
        val content = editTextPatient.text.toString()
    ...
    private fun addItemToRecyclerView(message: Message) {
        ...
        runOnUiThread {
            ...
            recyclerViewP.scrollToPosition(chatList.size - 1) //move focus on last message
        }
    }
