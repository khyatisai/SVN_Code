...
class ChatRoomAdapterDoctorNurseChat(val context: Context?, val chatList: ArrayList<Message>) :
    RecyclerView.Adapter<ChatRoomAdapterDoctorNurseChat.ViewHolder>() {
        ...
        when (viewType) {
            ...
            0 -> {
                view = LayoutInflater.from(context)
                    .inflate(R.layout.row_chat_doctor_right, parent, false)
