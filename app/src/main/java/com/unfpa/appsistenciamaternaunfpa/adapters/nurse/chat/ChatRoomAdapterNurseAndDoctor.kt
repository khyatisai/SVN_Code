...
class ChatRoomAdapterNurseAndDoctor(val context: Context?, val chatList: ArrayList<Message>) : RecyclerView.Adapter<ChatRoomAdapterNurseAndDoctor.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        when(viewType){
            ...
            0 ->{
                view = LayoutInflater.from(context).inflate(R.layout.row_chat_user_nurse,parent,false)
