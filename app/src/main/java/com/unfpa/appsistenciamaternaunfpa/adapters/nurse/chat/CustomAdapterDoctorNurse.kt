...
import com.unfpa.appsistenciamaternaunfpa.activities.nurse.chat.ChatRoomActivityDoctorNurse
import com.unfpa.appsistenciamaternaunfpa.activities.nurse.chat.ChatRoomActivityNurse
import com.unfpa.appsistenciamaternaunfpa.activities.nurse.chat.ChatRoomActivityPatientNurse
import com.unfpa.appsistenciamaternaunfpa.utils.AppUtils
import java.util.*

class CustomAdapterDoctorNurse(
    ...
    RecyclerView.Adapter<CustomAdapterDoctorNurse.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.activity_doctor_list, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { // display a toast with person name on item click
            ...
            if (getMyUserId != "") {
                ...
                val intent = Intent(context, ChatRoomActivityDoctorNurse::class.java)
                ...
                intent.putExtra("roomName2", "$user,$getMyUserId")
...
//            Toast.makeText(context, nombrePac[position], Toast.LENGTH_SHORT).show()
    ...
    inner class MyViewHolder(itemView: View) : ViewHolder(itemView) {
        ...
        var rlNotification: RelativeLayout =
            itemView.findViewById<View>(R.id.rlNotification) as RelativeLayout
    }
}