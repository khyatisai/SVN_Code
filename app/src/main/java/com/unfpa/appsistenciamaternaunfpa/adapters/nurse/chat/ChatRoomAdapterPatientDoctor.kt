...
import com.unfpa.appsistenciamaternaunfpa.ChatRoomAdapterPatient
import com.unfpa.appsistenciamaternaunfpa.Message
import com.unfpa.appsistenciamaternaunfpa.R

class ChatRoomAdapterPatientDoctor(val context: Context?, val chatList: ArrayList<Message>) :
    RecyclerView.Adapter<ChatRoomAdapterPatientDoctor.ViewHolder>() {
        ...
        when (viewType) {
            ...
            0 -> {
                view = LayoutInflater.from(context)
                    .inflate(R.layout.row_chat_user_patient , parent, false)
                Log.d("user inflating", "viewType : ${viewType}")
            }

            1 -> {
                view = LayoutInflater.from(context)
                    .inflate(R.layout.row_chat_partner_patient, parent, false)
