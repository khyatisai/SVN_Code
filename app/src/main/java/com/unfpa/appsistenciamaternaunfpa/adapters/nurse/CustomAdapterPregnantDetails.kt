...
import com.unfpa.appsistenciamaternaunfpa.activities.nurse.appointment.AppointmentSummaryActivity
...
class CustomAdapterPregnantDetails(
    ...
    private var patientDetail: JSONArray
) :
    RecyclerView.Adapter<CustomAdapterPregnantDetails.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val v =
            LayoutInflater.from(parent.context).inflate(R.layout.item_patient_detail, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { // display a toast with person name on item click
            ...
            var intent = Intent(context, AppointmentSummaryActivity::class.java)
            ...
            intent.putExtra(
                ...
                tvmainReasonForTheConsultation[position]
            )*/
            intent.putExtra(
                "appointmentJson",
                patientDetail.toString()
            )
            intent.putExtra(
                "selectedAppointmentPos",
                position
            )
    ...
    inner class MyViewHolder(itemView: View) : ViewHolder(itemView) {
        var FechaAppointment: TextView =
            itemView.findViewById<View>(R.id.tvFechaAppointment) as TextView
        var Hora: TextView = itemView.findViewById<View>(R.id.tvHora) as TextView
        var TypeAppointment: TextView =
            itemView.findViewById<View>(R.id.tvTypeAppointment) as TextView
