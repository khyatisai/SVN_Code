...
class ChatRoomAdapterPatientNurse(
    val context: Context?,
    val chatList: ArrayList<Message>,
    var typeReceiver: String = "enfermera"
) :
    RecyclerView.Adapter<ChatRoomAdapterPatientNurse.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        when (viewType) {
            ...
            1 -> {
                if (typeReceiver.equals("enfermera")) {
                    view = LayoutInflater.from(context)
                        .inflate(R.layout.row_chat_partner_nurse, parent, false)
