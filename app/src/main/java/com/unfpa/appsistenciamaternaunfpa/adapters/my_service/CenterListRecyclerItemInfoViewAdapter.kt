...
class CenterListRecyclerItemInfoViewAdapter(
    ...
    override fun getItemCount(): Int = count  // myServiceCenterList.size // //

    inner class MyServiceCenterListViewHolder(itemView: View) :
        ...
        fun bindView(myServiceCenterList: ServiceCenterDetailEntity) {
            ...
            itemView.txtDistance.text = myServiceCenterList.distance + "km"
    ...
    fun setMyServiceCenterList(
        myServiceCenterList: List<ServiceCenterDetailEntity>, myServiceId: String
    ) {
