...
class IntroAdapter(private val IntroList: ArrayList<Type>, activity: androidx.fragment.app.FragmentActivity, itemName: String ) : androidx.recyclerview.widget.RecyclerView.Adapter<IntroAdapter.CountryViewHolder>() {
    ...
    override fun getItemCount(): Int { return IntroList.size }
