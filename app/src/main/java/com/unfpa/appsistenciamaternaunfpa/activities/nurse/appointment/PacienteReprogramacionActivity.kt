...
import kotlinx.android.synthetic.main.activity_reprogramacion_paciente_nurse.*
...
class PacienteReprogramacionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reprogramacion_paciente_nurse)
        ...
        calendarView3?.setOnDateChangeListener { view, year, month, dayOfMonth ->
            ...
            Toast.makeText(this@PacienteReprogramacionActivity, DateAppointment, Toast.LENGTH_SHORT)
                .show()
        }
...
//        shape = activity?.let { getDrawable(it,R.drawable.boton_redondo_relleno) }
        shape = getDrawable(R.drawable.round_shape_green)
        shape2 = getDrawable(R.drawable.button_round_green)
