...
import kotlinx.android.synthetic.main.activity_register_paciente5.*


class PacienteAdd5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_register_paciente5)
