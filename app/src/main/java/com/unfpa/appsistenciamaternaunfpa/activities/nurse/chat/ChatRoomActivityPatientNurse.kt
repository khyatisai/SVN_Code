...
class ChatRoomActivityPatientNurse : AppCompatActivity(), View.OnClickListener {

    private var toolbar: Toolbar? = null
    val TAG = ChatRoomActivityPatientNurse::class.java.simpleName
...
//            Toast.makeText(this, userName.toString() + roomName.toString(), Toast.LENGTH_LONG).show()
        ...
        chatRoomAdapterPatient = ChatRoomAdapterPatientNurse(this, chatList);
