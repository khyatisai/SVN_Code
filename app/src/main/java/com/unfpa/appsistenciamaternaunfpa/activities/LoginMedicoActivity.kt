...
import kotlinx.android.synthetic.main.activity_login_medico.*
...
//        }
        ...
        txtViewRegister.setOnClickListener{
            var intent = Intent(this, register_medico::class.java)
            startActivity(intent)
        }
        txtCambioPass.setOnClickListener {
...
//        }
    ...
    fun LoginMedicoActivity.getVolleyError(error: VolleyError): String {
        var errorMsg = ""
