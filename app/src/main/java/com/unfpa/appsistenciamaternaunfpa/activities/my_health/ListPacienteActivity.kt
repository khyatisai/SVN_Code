...
import com.unfpa.appsistenciamaternaunfpa.adapters.nurse.chat.CustomAdapterDoctorNurse
import com.unfpa.appsistenciamaternaunfpa.adapters.patient.CustomAdapterDoctorAndDoctorList
import com.unfpa.appsistenciamaternaunfpa.adapters.patient.CustomAdapterPregnantList2
...
class ListPacienteActivity : AppCompatActivity() {
    ...
    var getNurse = EndPoints.URL_HEROKU +  "/api/v1/user/message/getnurse"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar!!.setNavigationOnClickListener(object : View.OnClickListener {
            override
            fun onClick(v: View) {
                val intent = Intent(application, MainDoctorActivity::class.java)
            ...
            Response.Listener { response ->
                ...
                for (i in 0 until dataArray.length()) {
                    ...
                    var nombrecomplet = dataArray.getJSONObject(i)
                        ...
                        .getString("lastname")
                    var doctorid = dataArray.getJSONObject(i).getString("id")
