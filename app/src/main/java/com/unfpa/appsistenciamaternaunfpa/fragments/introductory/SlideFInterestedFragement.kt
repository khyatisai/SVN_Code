...
import com.unfpa.appsistenciamaternaunfpa.adapters.introductory.IntroAdapterForInterest
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val adapter = IntroAdapterForInterest(
                (activity as IntroductoryActivity).getInterestList() as ArrayList<Type>,
                this.activity!!,
