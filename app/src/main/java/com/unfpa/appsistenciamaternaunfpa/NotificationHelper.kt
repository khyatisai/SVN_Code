...
object NotificationHelper {
    ...
    private const val CHANNEL_ID = "com.unfpa.appsistenciamaternaunfpa.notification_channel"
    ...
    public fun onHandleEvent(title: String, description: String, context: Context?) {
        ...
        if (title.isNotEmpty()) {
            ...
            val notificationManager: NotificationManager =
                context?.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
            val countDownIntent = Intent(context, TypeAccountActivity::class.java)
            ...
            mNotification = NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setSmallIcon(com.unfpa.appsistenciamaternaunfpa.R.mipmap.ic_launcher)
                .setAutoCancel(true)
