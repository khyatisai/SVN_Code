...
import com.unfpa.appsistenciamaternaunfpa.activities.DialogListUsersFragment
...
class CustomAdapterGetAllUserBySearch(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.fragment_users_searchlistitem, parent, false)
...
//            Toast.makeText(context, NombreCompletoBrigadista?.get(position), Toast.LENGTH_SHORT).show()
            ...
            if(tipo == "1"){
                (context as FragmentActivity).supportFragmentManager.findFragmentByTag("tagdialogcalendar").let {
...
//                }
                ...
                (context as FragmentActivity).supportFragmentManager.findFragmentByTag("bottomSheetFragment1").let {
            ...
            if(tipo == "1"){
                bottomSheetFragment.show((context as FragmentActivity).supportFragmentManager, "tagdialogcalendar")
            }
            else{
                bottomSheetFragment.show((context as FragmentActivity).supportFragmentManager, "bottomSheetFragment1")
            }
