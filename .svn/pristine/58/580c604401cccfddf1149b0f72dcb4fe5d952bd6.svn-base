...
import kotlinx.android.synthetic.main.activity_register_medico.*
import kotlinx.android.synthetic.main.activity_register_medico.etApellido
import kotlinx.android.synthetic.main.activity_register_medico.etCedula
import kotlinx.android.synthetic.main.activity_register_medico.etContrasena
import kotlinx.android.synthetic.main.activity_register_medico.etCorreo
import kotlinx.android.synthetic.main.activity_register_medico.etNombre
import kotlinx.android.synthetic.main.activity_register_medico.etTelefono
...
class register_medico : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegisterMedico.setOnClickListener {
            ...
            if (areFieldsValid(etfirtsName, etLastName, etEmail, etPassword, etPhone, etID)) {
                ...
                try {
                    ...
                    jsonobj.put("typeUser", "medico")

                    val que = Volley.newRequestQueue(this)
                    val req = JsonObjectRequest(Request.Method.POST, REGISTER, jsonobj,
                        Response.Listener { response ->
                            //Toast.makeText(this, "Medico Registrado", Toast.LENGTH_SHORT).show()
                            ...
                            var intent = Intent(this, LoginMedicoActivity::class.java)
                            startActivity(intent)
                            println(response)
                        }, Response.ErrorListener { error ->
                            registerMError.setText(getVolleyError(error))
                        })
                    que.add(req)
                } catch (e: JSONException) {
                    e.printStackTrace()
                    progressBar.visibility = View.GONE
                    btnRegisterMedico.isEnabled = true
                }

            }
        }

        tvIniciaSesion2.setOnClickListener {
    ...
    fun register_medico.getVolleyError(error: VolleyError): String {
        var errorMsg = ""
