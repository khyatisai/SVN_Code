 ...
 */
class InformacionPregnantFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val rootView = inflater.inflate(R.layout.fragment_my_informacion, container, false)
...
//        tabLayout!!.setupWithViewPager(viewPager)
    ...
    private fun setupViewPager(viewPager: androidx.viewpager.widget.ViewPager) {
        ...
        adapter.addFragment(GuidesFragment(), "Info")//"Guides"
