package com.unfpa.appsistenciamaternaunfpa.adapters.my_favourites
...
import kotlinx.android.synthetic.main.item_srh_content_list.view.cardSRHContent
import kotlinx.android.synthetic.main.item_srh_content_list.view.txtHeader
import kotlinx.android.synthetic.main.item_srh_content_list.view.txtShortDesc
import kotlinx.android.synthetic.main.item_srh_favourites_list.view.*
...
class SRHContentListAdapter(activity: androidx.fragment.app.FragmentActivity) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): androidx.recyclerview.widget.RecyclerView.ViewHolder {
        ...
        return ContentListViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.item_srh_favourites_list,
                parent,
                false
            )
    ...
    inner class ContentListViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
        ...
        fun bindView(contentMaster: SRHContent) {
            itemView.txtHeader.text =
                HtmlCompat.fromHtml(contentMaster.title.toString(), HtmlCompat.FROM_HTML_MODE_LEGACY).toString()
            itemView.txtShortDesc.text =
                HtmlCompat.fromHtml(contentMaster.field_short_description.toString(), HtmlCompat.FROM_HTML_MODE_LEGACY)
                    .toString()
            itemView.txtThematicArea.text = activity.getString(R.string.thematic_area) + HtmlCompat.fromHtml(
                contentMaster.field_thematic_area.toString(),
