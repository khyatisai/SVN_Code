...
class IntroAdapter(
    ...
    itemName: String
) : androidx.recyclerview.widget.RecyclerView.Adapter<IntroAdapter.CountryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CountryViewHolder, position: Int) {
        ...
        if (itemName.equals(Constant.ITEM_GENDER)) {
            selectedItem = sharedPreference.getString(Constant.ITEM_GENDER, "").toString()
        }
        if (itemName.equals(Constant.ITEM_EDUCATION)) {
            selectedItem = sharedPreference.getString(Constant.ITEM_EDUCATION, "").toString()

        }
        if (itemName.equals(Constant.ITEM_AGE_GROUP)) {
            selectedItem = sharedPreference.getString(Constant.ITEM_AGE_GROUP, "").toString()

        }
        if (selectedItem.equals(IntroList[position].itemName)) {
