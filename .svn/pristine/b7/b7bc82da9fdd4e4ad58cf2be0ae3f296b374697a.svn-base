...
class PacienteAdd6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_register_paciente6)
        ...
        calendarView3?.minDate = Calendar.getInstance().timeInMillis
            ...
            Toast.makeText(this@PacienteAdd6Activity, DateAppointment, Toast.LENGTH_SHORT).show()
        }
...
//                rbTelMedicine.setPadding(31, 0, 0, 0)
        ...
        btnProximo5.setOnClickListener {
            ...
            if(ValidateForm()){
                var intent =  Intent(this, PacienteAdd7Activity::class.java)
