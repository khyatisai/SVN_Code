...
import com.unfpa.appsistenciamaternaunfpa.adapters.doctor.CustomAdapterGetAllUserBySearch
            ...
            val reqq = JsonObjectRequest(
                ...
                Response.Listener { response ->
                    ...
                    for (i in 0 until dataArray.length()) {
                        ...
                        gestationWeeksDate = dataArray.getJSONObject(i).getString("gestationWeeksDate")
                        var pathologicalAntecedents = dataArray.getJSONObject(i).getString("pathologicalAntecedents")
                        var treatmentsReceived = dataArray.getJSONObject(i).getString("treatmentsReceived")
                        var medicalObservation = dataArray.getJSONObject(i).getString("medicalObservations")
